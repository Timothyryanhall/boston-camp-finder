...
- [ ] **Step 1: Keep saved panel visible in saved-only empty state**
...
- [ ] **Step 2: Reset saved-only mode when clearing**
...
- [ ] **Step 3: Give the zero-saved saved-only state an escape hatch**
